  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (selectedDocument !== 'all') {
        payload.documentPath = selectedDocument;
      }
      ...
      if (!response.ok) {
        ...
        throw new Error(
          errData.error || `Une erreur ${response.status} est survenue.`
        );
      }
      ...
      if (data.quiz && Array.isArray(data.quiz)) {
        ...
        throw new Error("L'API n'a pas renvoyé de quiz valide.");
      }
    } catch (err: unknown) {
        ...
        <>
          ...
          <div className="mb-4">
            <label
              ...
              className="block text-sm font-medium text-gray-700 mr-2 mb-1"
            >
          ...
          <div className="mt-6">
            ...
            {quiz && !isAttemptingQuiz && (
              <div className="p-4 bg-purple-50 rounded-lg text-center">
                <h3 className="text-lg font-medium text-brand-purple-dark">
                  Quiz Généré !
                </h3>
                <p className="mt-1 text-gray-700">
                  Un quiz de {quiz.length} questions est prêt.
                </p>
                <button
